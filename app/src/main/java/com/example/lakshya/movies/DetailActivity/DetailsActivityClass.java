...
public class DetailsActivityClass extends AppCompatActivity {
    Movie movie;
    Tv tv;
    int id;
    ImageView backDrop;
    ...
    InfoFragment movieFragment = new InfoFragment();
...
// set Fragmentclass Arguments
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
          ...
          switch (position){
              case 0:return movieFragment;
              case 1:return castFragment;
